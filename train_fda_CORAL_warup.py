...
def main():
    ...
    parser.add_argument('--balanced_domain_', action='store_true', help='Enable domain/class balanced batch sampling (supports DDP)')
    ...
    parser.add_argument('--coral_lambda_start', type=float, default=0.1, help='Initial CORAL weight after warmup ramp')
    parser.add_argument('--coral_lambda_target', type=float, default=0.5, help='Target CORAL weight after ramp-up')
